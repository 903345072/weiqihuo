...
class UserWithdraw extends \common\components\ARModel
{
    ...
    const OP_REASON_ONE = 1;
    const OP_REASON_TWO = 2;
    const OP_REASON_THREE = 3;
    ...
    public function attributeLabels()
    {
        return [
            ...
            'op_reason' => '理由：1信息填写有误，请认真填写后重新提交，2违规交易，请联系客服，3未知错误，请联系客服',
            'created_at' => '申请时间',
            'updated_at' => '审核时间',
        ];
    }
    ...
    public function search()
    {
        ...
        return self::find()
            ->filterWhere([
               ...
               // 'userWithdraw.op_reason' => $this->op_reason,
            ])
    ...
    public static function getOpStateMap($prepend = false)
    {
        $map = [
			...
			//self::OP_REASON_ONE => '信息填写有误，请认真填写后重新提交',
            //self::OP_REASON_TWO => '违规交易，请联系客服',
            //self::OP_REASON_THREE => '未知错误，请联系客服',
        ];
