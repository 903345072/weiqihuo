...
<body style="max-width:100%">
        ...
        <!--    首页      -->
            <ul class="index-head flex col-w <?=$type?>" style="max-width:100%">
                    <li class="le"><a href="/site/list" class="col-w"><i class="iconfont"></i></a></li>
                    <li class="mid" data-product-id="<?=$product->id?>" data-pro-no="<?=$product->table_name?>"><?=session('sim_type')=='sim'?'模拟':'产品'?>交易-<?=$product->name ?><i class="iconfont"></i></li>
                ...
                <?php foreach ($productArr as $key => $value): ?>
                    <a href="/site/detail?pid=<?=$value['id']?>&type=<?=session('sim_type')?>"><li class="col-5"><?=$value['name']?></li></a>
                     ...
                     <?php if (!empty(session('sim_type'))):?>
                        <a href="/site/detail"><li class="col-5">[返回交易]</li></a>
                        <?php endif?>
        ...
        <!--折线图TAB-->
            ...
            <ul id="pan" class="none col-1 chartBox">
                    ...
                    <li>成交量<em data-pan-totalqty="" class="fr col-up">-</em></li>
            ...
            <ul class="tr-head flex col-1 <?=$type?>">
                ...
                <!--li class="col-2">金券 <span id="bond" class="col-1">0</span> 张</-->
        ...
        <!--产品内容-->
            <div class="tr-content flex2">
                <span class="le flex2 pr">
                    <div>
                        <div class="col-1" style="font-size: .12rem;position: absolute;top: .35rem;"><?=$product->name ?><!-- /<?=$product->code ?> -->
                           <em style="display:none" data-pan-proNo="" style="font-size:.1rem"><?=$product->table_name ?></em>
                        </div>
